ENVIRONMENT_SETUP_AGENT_INSTRUCTION = """
    ...
    <instructions>
        ...
        <process_flow>
            ...
            3. Onece all 'pending' clarifications are collected, execute 'create_environment_details' tool with collected details by yourself. (Don't give any output to user other than asking 'pending' clarifications)
