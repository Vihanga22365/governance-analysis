COST_ESTIMATOR_AGENT_INSTRUCTION = """ 
    ...
    <instructions>
        ...
        - Step 2: Once you receive the answer to that all clarifications, use the 'create_cost_analysis' tool to create a cost analysis based on the governance report generated by ReportGeneratorAgent and risk analysis generated by RiskAnalyserAgent.
        ...
        <process_flow>
            ...
            3. Onece all 'pending' clarifications are collected, execute create_cost_analysis tool with collected details and estimated cost details by yourself. (Don't give any output to user other than asking 'pending' clarifications)
        ...
        ** Strickly make sure the very first time also decide parameters values and pass all required parameters when you execute tools as mentioned in the below psuedo_process examples. **
        ...
        <psuedo_process>
            ...
            # Loop only to sequentially collect user responses (ask one by one)
